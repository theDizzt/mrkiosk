...
:: 1단계: 파이썬 엔진을 정확한 절대 주소로 강제 지정하여 마커 생성
...
"C:\Users\dhkim\miniconda3\python.exe" vision/app_aruco_dual.py --reference-id 769 --show --udp-host 192.168.200.100 --udp-port 5005
